<!-- Imports -->
<link rel='stylesheet' href='/raf-layoutPortal-full/resources/css/raf-layoutPortal-full.min.css' type='text/css' />
<script type='text/javascript' src='/raf-layoutPortal-full/resources/js/raf-layoutPortal-full.min.js'></script>
	...
	<div id="content">
	    <div class="padding">
	    	...
	    	<div id="visualizacaoPagina" class="clearfix">
	        	...
	        	<!-- Slot 1 -->
	            <div id="divSlot" class="editable-slot slotfull layout-1-1">
	            <@wcm.renderSlot id="Slot" editableSlot="true" />
	            </div>
		    </div>
	    </div>
	</div>
