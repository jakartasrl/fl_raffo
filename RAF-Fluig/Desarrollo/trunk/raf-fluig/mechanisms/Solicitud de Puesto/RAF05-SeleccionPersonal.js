...
function resolve(process,colleague){ 
	...
	log.info('***** Mecanismo RAF05-SeleccionPersonal para nroSolicitud: ' + nroSolicitud + ' attSeqId: ' + attSeqId);
	...
	log.info('***** Busqueda en RAF05-FormularioPrincipal nroSolicitud: ' + nroSolicitud + ' confidencial: ' + confidencial);
