function resolve(process,colleague, configXML){ 
	...
	log.info('***** Iniciando mecanismo de atribucion RAF11-Solicitante');
	
	var usuariosGerentes = getUserGteList("RAF08-GTE-DIST-");
	
	log.info('***** Finalizando mecanismo de atribucion RAF11-Solicitante, usuarios Gtes: ' + usuariosGerentes);
	...
	log.info('***** Finalizando mecanismo de atribucion RAF11-Solicitante, usuarios: ' + listaUsuarios);
