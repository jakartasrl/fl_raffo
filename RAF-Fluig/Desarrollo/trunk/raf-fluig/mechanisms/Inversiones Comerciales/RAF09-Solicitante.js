function resolve(process,colleague, configXML){ 
	...
	log.info('***** Iniciando mecanismo de atribucion RAF09-Solicitante');
	
	var usuariosGerentes = getUserGteList("RAF08-GTE-DIST-");
	var usuariosGestores = getUserGteList("RAF08-GTOR-PROCESO");
	
	var listaUsuarios = java.util.ArrayList();
	listaUsuarios.addAll(usuariosGerentes);
	listaUsuarios.addAll(usuariosGestores);
	
	log.info('***** Finalizando mecanismo de atribucion RAF09-Solicitante, usuarios: ' + listaUsuarios);
