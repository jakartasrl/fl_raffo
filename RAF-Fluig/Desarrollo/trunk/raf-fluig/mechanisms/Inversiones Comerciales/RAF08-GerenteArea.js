...
function resolve(process, colleague){ 
	...
	log.info('***** Iniciando mecanismo de atribucion RAF08-GerenteArea para nroSolicitud: ' + nroSolicitud);
	
	var codigoGrupo = formValue("codGrupoGteArea");
	...
	log.info('***** Finalizando mecanismo de atribucion RAF08-GerenteArea para nroSolicitud: ' + nroSolicitud + ', resultado: ' + resultado);
