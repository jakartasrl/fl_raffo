...
function resolve(process, colleague){ 
	...
	log.info('***** Iniciando mecanismo de atribucion RAF08-GerenteDistrito para nroSolicitud: ' + nroSolicitud);
	
	var codigoGrupo = formValue("codGrupoGteDistrito");
	...
	if (usuariosDelGrupo.size() != 1) { 
		...
		log.info('*****RAF08-GerenteDistrito para nroSolicitud: ' + nroSolicitud + " usuariosDelGrupo: " + usuariosDelGrupo);
		resultado.addAll(usuariosDelGrupo);
	}
	
	log.info('***** Finalizando mecanismo de atribucion RAF08-GerenteDistrito para nroSolicitud: ' + nroSolicitud + ', resultado: ' + resultado);
