...
function resolve(process, colleague){ 
	...
	log.info('***** Iniciando mecanismo de atribucion RAF08-GerentePromocion para nroSolicitud: ' + nroSolicitud);
	
	var codigoGrupo = formValue("codGrupoGtePromocion");
	...
	log.info('***** Finalizando mecanismo de atribucion RAF08-GerentePromocion para nroSolicitud: ' + nroSolicitud + ', resultado: ' + resultado);
