...
CREATE VIEW V_RAF06_QUIENES_ENTREVISTAN AS 
 SELECT *
FROM [TOTVS_FLUIG_PROD].[dbo].[ML001019]
GO

CREATE VIEW V_RAF06_TAREAS_ORDEN_PRIORIDAD AS 
 SELECT *
FROM [TOTVS_FLUIG_PROD].[dbo].[ML001020]
GO

CREATE VIEW V_RAF06_IDIOMAS AS 
 SELECT *
FROM [TOTVS_FLUIG_PROD].[dbo].[ML001021]
GO

CREATE VIEW V_RAF06_PROGRAMAS_INFORMATICA AS 
 SELECT *
FROM [TOTVS_FLUIG_PROD].[dbo].[ML001022]
GO

CREATE VIEW V_RAF06_DETALLE_COMPETENCIAS AS 
 SELECT *
FROM [TOTVS_FLUIG_PROD].[dbo].[ML001023]
GO
 
CREATE VIEW V_RAF06_BENEFICIOS AS 
 SELECT *
FROM [TOTVS_FLUIG_PROD].[dbo].[ML001024]
GO
 
CREATE VIEW V_RAF06_DOCUMENTOS AS 
 SELECT *
FROM [TOTVS_FLUIG_PROD].[dbo].[ML001025]
GO

UPDATE [TOTVS_FLUIG_PROD].[dbo].[ML001018] SET fechaInicioSolicitud = CAST([dbo].F_TO_DATE(fechaInicioSolicitud) AS VARCHAR)
GO

UPDATE [TOTVS_FLUIG_PROD].[dbo].[ML001018] SET fechaFinSolicitud = CAST([dbo].F_TO_DATE(fechaFinSolicitud) AS VARCHAR)
GO