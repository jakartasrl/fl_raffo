...
CREATE VIEW [dbo].[V_REQUERIMIENTO_INFORMATICO] AS 
	SELECT
		...
		FROM [ML001018] fp1 WHERE fp1.id = fp.id ),1,1,'') AS telefonia
	FROM [ML001018] fp, [DOCUMENTO] d
