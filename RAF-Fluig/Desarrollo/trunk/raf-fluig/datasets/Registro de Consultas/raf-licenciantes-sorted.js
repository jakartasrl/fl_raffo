/*
 * Dataset: raf-licenciantes-sorted
 * Descripcion: Licenciantes Ordenados.
 */
function createDataset(fields, constraints, sortFields) { 
	...
	var dataset = DatasetFactory.getDataset("raf-licenciantes", null, constraints, sortingFields);
