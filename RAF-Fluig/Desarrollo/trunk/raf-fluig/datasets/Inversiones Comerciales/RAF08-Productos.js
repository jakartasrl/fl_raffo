/*
 * Devuelve el dataset raf-marcas consultandolo directo a la tabla.
 */
function createDataset(fields, constraints, sortFields) {
	...
	var where = arq.sql.whereHelper({
		...
		filtros: {
			'descripcionProducto': function(filtro) {
	...
	return arq.sql.sql2Dataset({
		...
		sql: " SELECT distinct marca as codigoProducto, marca as descripcionProducto" + 
