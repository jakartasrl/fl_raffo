...
function createDataset(fields, constraints, sortFields) {
	 ...
	 dataset.addRow(['RAF07.carpetaSolicitudes.docId', '25361']);
	 dataset.addRow(['RAF07.QAD.domain', 'RAFFO']);
	 dataset.addRow(['RAF07.QAD.fileURL', 'https://portalweb.raffo.com.ar/portal/p/1/ecmnavigation?app_ecm_navigation_doc=']);
	 ...
	 dataset.addRow(['RAF08.carpetaAdjuntos.docId', '48934']);
	 ...
	 dataset.addRow(['RAF09.carpetaAdjuntos.docId', '48937']);
	 ...
	 dataset.addRow(['RAF10.carpetaAdjuntos.docId', '111972']);
	 return dataset;
}