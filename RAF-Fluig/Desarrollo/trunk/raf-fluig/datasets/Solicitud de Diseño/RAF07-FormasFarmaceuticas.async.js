/**
 * Codigo: RAF07-FormasFarmaceuticas.async
 * Descripcion: Consulta las FormasFarmaceuticas a QAD.
 */
...
function onSync(lastSyncDate) {
	...
	var formasFarmaceutica = arq.prop.get("RAF07.QAD.formasFarmaceutica");
	...
	servicioQAD.code_find(dominio,formasFarmaceutica,arrayCodeFind);
