...
public class ReporteInversionComercialFilter {
	...
	public ReporteInversionComercialFilter(Date fechaSolicitudDesde, Date fechaSolicitudHasta, String distrito, 
			String area, TipoInversion tipoInversion, String apellido, Integer numeroSolicitud, Estado estado,
			Integer congreso) {
