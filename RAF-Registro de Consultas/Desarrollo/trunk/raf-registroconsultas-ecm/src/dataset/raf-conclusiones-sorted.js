/*
 * Dataset: raf-conclusiones-sorted
 * Descripcion: Conclusiones Ordenadas.
 */
function createDataset(fields, constraints, sortFields) { 
	...
	var dataset = DatasetFactory.getDataset("raf-conclusiones", null, constraints, sortingFields);
