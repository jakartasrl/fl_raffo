						...
						custom: function() {
							...
							$("#tipologia").ecmzoom({
								...
								callback: function(res){
									...
									if(res['soloConfirmacionLectura'] != "true"){
										...
										$("#estado").ecmzoom({
											...
											filterValues: [{ id: 'metadata%23active', value: true}, {id: 'codigoTipologia', value: $('#codigo').val()}], 
								...
								clean: function(field) {
									...
									$('#estado').ecmzoom("option", "filterValues", [{ id: 'metadata%23active', value: true}, {id: 'codigoTipologia', value: $('#codigo').val()?$('#codigo').val():'-1'}]); 
