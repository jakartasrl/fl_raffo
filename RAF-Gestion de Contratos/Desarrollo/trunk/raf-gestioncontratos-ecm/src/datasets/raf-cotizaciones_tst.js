...
function createDataset(fields, constraints, sortFields) { 
	...
	var codigoMoneda1 = getContraint(constraints, "codigoMoneda1")? getContraint(constraints, "codigoMoneda1").initialValue : "ARS";
	...
	newDataset.addRow(new Array(codigoMoneda1,codigoMoneda2,cotizacion,"05/04/2016"));
